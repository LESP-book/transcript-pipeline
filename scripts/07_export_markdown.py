...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="执行阶段 7：写入最终 Markdown 文稿。")
...
def main() -> int:
    ...
    logger.info("阶段启动 | export-markdown | profile=%s", loaded_settings.active_profile_name)
    ...
    logger.info("阶段完成 | export-markdown | %s", summarize_export_results(summary))
    return 0
