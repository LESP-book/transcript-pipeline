...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="执行最小块级对齐。")
...
def main() -> int:
    ...
    logger.info("阶段启动 | align | profile=%s", loaded_settings.active_profile_name)
    ...
    logger.info("阶段完成 | align | %s", summarize_alignment_results(summary))
    return 0
