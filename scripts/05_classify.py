...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="执行块级内容候选分类。")
...
def main() -> int:
    ...
    logger.info("阶段启动 | classify | profile=%s", loaded_settings.active_profile_name)
    ...
    logger.info("阶段完成 | classify | %s", summarize_classification_results(summary))
    return 0
